    ...
    <section aria-label="hero" className="relative min-h-[70vh] isolate overflow-hidden bg-gradient-to-b from-[#f0562e] to-[#f97316]">
      <FadeContainer className="relative flex flex-col items-center justify-center pt-20 pb-12">
        ...
        <p className="mt-5 max-w-xl text-center text-base text-balance text-white/80 sm:mt-8 sm:text-lg">
          <FadeSpan>Join the community shaping the future of artificial intelligence</FadeSpan>
        </p>
        <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center">
          ...
          <FadeDiv>
            <a
              className="inline-flex cursor-pointer flex-row items-center justify-center gap-1 rounded-md px-5 py-3 leading-4 font-medium tracking-wide whitespace-nowrap text-white hover:text-white/80 transition-all duration-200 ease-in-out"
              href="/register"
            >
              Join Community
        ...
        <div className="absolute inset-0 -z-10 flex items-center justify-center transform-gpu overflow-hidden backdrop-blur-sm">
          <GameOfLife />
        </div>
      </FadeContainer>
    </section>
